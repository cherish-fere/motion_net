...
from FCN.FCN_model import inference_attention
...
def train(path, phase, batch_size, height, width, channels, num_classes, epoches, init_lr):
	...
	print(train_n_img.shape)
	print(train_label.shape)
	print(val_n_img.shape)
	...
	with tf.Session(config=config) as sess:
		...
		# -------------------------------log------------------------------- #
		merge = tf.summary.merge([loss_summary, acc_summary, miou_summary, dice_summary])
